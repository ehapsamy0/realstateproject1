...
def contact(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request,'You Have already mode an inquird for this listing')
        ...
        send_mail(
            ...
            'There has been inquiry'+listing + '.sign into the admin panel for more info',
            'ehapsamy434@gmail.com',
            [realtor_email,'ehapsamy434@gmail.com'],
            fail_silently=False,
        )
